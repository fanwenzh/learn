...
= @EnableAutoConfiguration 自动装配 + @ComponentScan(excludeFilters={@ComponentScan.Filter(type=CUSTOM,classes=TypeExcludeFilter.class),}) 默认配置 等等
// 自配置：
...
// 声明配置(java)类
@Configuration
@PropertySource(value={"classpath:jdbc.properties", "otherProties"})
