...
public class DSASignature {
        ...
        public DSASignature() throws GeneralSecurityException {
            // generate key pair:
        ...
        public DSASignature(byte[] pk, byte[] sk) throws GeneralSecurityException {
            // create from bytes:
        ...
        public byte[] sign(byte[] message) throws GeneralSecurityException {
            // sign by sk:
            Signature signature = Signature.getInstance("SHA1withDSA"); // SHA256withDSA, SHA512withDSA
        ...
        public static void main(String[] args) throws Exception {
            ...
            DSASignature rsas = new DSASignature();
